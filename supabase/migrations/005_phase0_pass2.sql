...
--        - Lets the API rely on a 23505 unique violation instead of a
...
--    means a concurrent duplicate pending insert raises a 23505 unique
--    violation, which the route catches and treats as a soft success. This
--    closes the TOCTOU window of a count-then-insert.
