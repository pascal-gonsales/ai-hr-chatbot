  ...
  const [messages, setMessages] = useState<DemoMessage[]>([
    {
      ...
      role: 'assistant',
      content:
        "Hi Alex, I'm your TeamChat AI agent. I can help with tips, schedules, time-off requests, policies, and drafting messages to management. What can I look up for you?",
    },
  ])
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100 flex flex-col">
      ...
      <div className="bg-amber-500/10 border-b border-amber-500/30 text-amber-200 text-xs px-4 py-2 text-center">
        🎭 Demo mode, Alex Demo at fictional Northstar Demo Bistro. Read-only fixtures, no production data.{' '}
      ...
      <div className="border-b border-zinc-800 px-4 py-3 flex items-center justify-between">
        <div>
          ...
          <div className="text-xs text-zinc-500">Alex Demo · Northstar Demo Bistro</div>
        </div>
        <a
