          ...
          <ul className="space-y-2 text-sm text-zinc-400">
            ...
            <li className="flex gap-2">
              ...
              <span>
                ...
                (FR/EN). The fixture employee Alex Demo is set to English; ask in French and
        ...
        <div className="rounded-lg border border-zinc-800 bg-zinc-900/50 p-5 space-y-3">
          ...
          <div className="text-sm text-zinc-400 space-y-1">
            <p>
              ...
              <span className="text-zinc-200">Alex Demo</span> (server)
            </p>
            <p>
              <span className="text-zinc-500">Restaurant:</span>{' '}
              <span className="text-zinc-200">Northstar Demo Bistro</span> (fictional)
            </p>
            <p>
              <span className="text-zinc-500">Recent activity:</span>{' '}
              <span className="text-zinc-200">6 shifts logged, $200.00 tip balance (sample data)</span>
            </p>
          </div>
        </div>
