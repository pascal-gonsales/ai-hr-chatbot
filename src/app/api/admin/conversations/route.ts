...
// There is intentionally NO GET on this route: admin conversation listing and
// per-conversation message reads happen client-side via the RLS-respecting
// Supabase browser client under the admin SELECT policies.
